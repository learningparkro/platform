...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.email_confirmed'
        db.add_column('user_player', 'email_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.email_confirmed'
        db.delete_column('user_player', 'email_confirmed')
